...
def run_command(command):
    ...
    # Strip leading/trailing whitespaces/newlines from multi-line commands
    command_str = command.strip()
    if command_str.startswith("python "):
        command = python_exe + command_str[6:]
    elif " python " in command_str:
        command = command_str.replace(" python ", f" {python_exe} ")
...
commands = [
    ...
    --rough-fq-gen-model-name gpt-5.4-mini \
    --final-fq-gen-model-name anthropic/claude-3.5-sonnet \
    --final-fq-verification-model-name gpt-5.4-mini \
    -lax \
...
def expected_files(test_exist: bool = False):
    files = [
        "src/data/news_api_test/rough/gpt-5.4-mini/2024-09-01_to_2024-09-04/num_pages_1/num_articles_all/rough_fq_data.jsonl",
        "src/data/news_api_test/rough/gpt-5.4-mini/2024-09-01_to_2024-09-04/num_pages_1/num_articles_all/validated_articles.jsonl",
        "src/data/news_api_test/fq/gpt-5.4-mini/2024-09-01_to_2024-09-04/num_pages_1/num_articles_all/strict_res_checking_fqs.jsonl",
        "src/data/news_api_test/fq/gpt-5.4-mini/2024-09-01_to_2024-09-04/num_pages_1/num_articles_all/lax_res_checking_fqs.jsonl",
