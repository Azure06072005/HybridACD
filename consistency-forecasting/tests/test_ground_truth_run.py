...
commands_forecaster_class = [
    "python src/ground_truth_run.py --forecaster_class BasicForecaster --forecaster_options model=gpt-5.4-mini --input_file src/data/fq/real/metaculus_cleaned_formatted_20240501_20240815.jsonl --num_lines 3 --run --output_dir src/data/forecasts/test_output_basic",
...
commands_custom_forecaster = [
    "python src/ground_truth_run.py --custom_path src/forecasters/basic_forecaster.py::BasicForecaster --forecaster_options model=gpt-5.4-mini --input_file src/data/fq/real/metaculus_cleaned_formatted_20240501_20240815.jsonl --num_lines 3 --run --output_dir src/data/forecasts/test_output_custom",
]
