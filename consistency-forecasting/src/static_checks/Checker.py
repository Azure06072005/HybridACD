        ...
        **kwargs,
        ...
        with jsonlines.open(log_path, mode="a") as writer:
            ...
            for line in data:
                ...
                answers_: dict[str, Forecast] = forecaster.elicit(line_obj, rule=self.__class__.__name__, **kwargs)
    ...
    async def test(
        ...
        **kwargs,
        ...
        with jsonlines.open(log_path, mode="a") as writer:
            ...
            elicit_func = functools.partial(forecaster.elicit_async, rule=self.__class__.__name__, **kwargs)
