...
You MUST wrap the list of questions in a JSON object under the key "questions". For example:
{{
  "questions": [
    {{
      "title": "Will Singapore mandate...",
      "body": "This resolves as YES if...",
      "resolution": true
    }}
  ]
}}
Do NOT return the array directly. Always wrap it inside a JSON object with the "questions" key.
""",
    }
